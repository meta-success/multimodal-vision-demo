...
<h4 style='text-align: center; color: #7f8c8d;'>Upload an image, type a question, and click 'Analyze' to get insights.</h4>
<hr>
...
@st.cache_resource
def load_models():
    with st.spinner("🔄 Loading AI Models... Please wait (This may take a moment on first load)."):
...
# User question input
user_question = st.text_input("💬 Ask a question about this image (Optional):", placeholder="e.g. What text is in this document?")
...
if uploaded_file is not None:
    if st.button("🔍 Analyze Image"):
        ...
        # --- PROCESS THE IMAGE ---
        with st.spinner("🧠 AI is analyzing the image (This may take up to 60 seconds)..."):
            # 1. Vision AI (BLIP-2)
